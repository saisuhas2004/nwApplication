...
class homeAddress:
    ...
    def homeAddressInfo(self, State):
        #sleep(3)
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.streetName1, "Name")
        ...
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.homeAddressCity, "Xpath")
        ...
        if State != 'NC':
            homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.otherStateDropdown, "Xpath")
        ...
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, pageMapper.CommonObjects.saveAndContinue, "Xpath")
        ...
        #USPS record
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.uspsRecord, "Xpath")
        ...
        #Mailing address
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.mailingAddressYes, "Xpath")
       ...
       # sleep(5)
        ...
        # Contact information
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.phoneTypeHome, "Xpath")
    ...
    # added
        ...
        #Contact preferences
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.mailPreference, "Xpath")
        self.driver.find_element(By.XPATH, homeAddress.mailPreference).click()
        self.driver.find_element(By.XPATH, pageMapper.CommonObjects.saveAndContinue).click()
        #sleep(5)

        #Application help
        homeAddress.Commonmethods.test_timeouts_explicit_wait(self, homeAddress.applicationHelpNo, "Xpath")
